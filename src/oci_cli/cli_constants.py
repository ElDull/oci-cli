...
OCI_CLI_AUTH_INSTANCE_PRINCIPAL_FROM_FILES = 'instance_principal_from_files'
OCI_CLI_AUTH_SIGNED_JWT = 'signed_jwt'
...
OCI_CLI_PROXY_ENV_VAR = 'OCI_CLI_PROXY'
...
# Instance principal from local files (cert/key copied from an OCI instance)
OCI_CLI_INSTANCE_CERTIFICATE_FILE_ENV_VAR = 'OCI_CLI_INSTANCE_CERTIFICATE_FILE'
OCI_CLI_INSTANCE_KEY_FILE_ENV_VAR = 'OCI_CLI_INSTANCE_KEY_FILE'
OCI_CLI_INSTANCE_INTERMEDIATE_CERTIFICATE_FILE_ENV_VAR = 'OCI_CLI_INSTANCE_INTERMEDIATE_CERTIFICATE_FILE'
OCI_CLI_JWT_TOKEN_FILE_ENV_VAR = 'OCI_CLI_JWT_TOKEN_FILE'
OCI_CLI_SESSION_KEY_FILE_ENV_VAR = 'OCI_CLI_SESSION_KEY_FILE'
...
OCI_CONFIG_ENV_VARS = {
    ...
    OCI_CLI_INSTANCE_CERTIFICATE_FILE_ENV_VAR: 'instance_certificate_file',
    OCI_CLI_INSTANCE_KEY_FILE_ENV_VAR: 'instance_key_file',
    OCI_CLI_INSTANCE_INTERMEDIATE_CERTIFICATE_FILE_ENV_VAR: 'intermediate_certificate_file',
    OCI_CLI_JWT_TOKEN_FILE_ENV_VAR: 'jwt_token_file',
    OCI_CLI_SESSION_KEY_FILE_ENV_VAR: 'session_key_file',
}
